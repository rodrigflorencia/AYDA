 ...
 */
template <class V, class C> GrafoRotulado<V, C>::GrafoRotulado() {
...
GrafoRotulado<V, C>::GrafoRotulado(bool noDirigido) {
 ...
 */
template <class V, class C> void GrafoRotulado<V, C>::addVertice(const V &v) {
 ...
 */
template <class V, class C>
void GrafoRotulado<V, C>::addArco(const V &u, const V &v) {
 ...
 */
template <class V, class C>
bool GrafoRotulado<V, C>::hayArco(const V &u, const V &v) const {
...
template <class V, class C>
list<V> GrafoRotulado<V, C>::getAdyacentes(const V &v) const {
  if (grafoMapa.find(v) == grafoMapa.end())
    return list<V>();
  const map<V, C> &ady = grafoMapa.find(v)->second;
  list<V> destino;
  for (typename map<V, C>::const_iterator it = ady.begin(); it != ady.end();
       it++) {
...
template <class V, class C> list<V> GrafoRotulado<V, C>::getVertices() const {
  list<V> v;
  for (typename map<V, map<V, C>>::const_iterator it = this->grafoMapa.begin();
 ...
 */
template <class V, class C> int GrafoRotulado<V, C>::nVertices() const {
...
// ==============================================
template class GrafoRotulado<int, int>;
template class GrafoRotulado<char, int>;
template class GrafoRotulado<char, char>;
template class GrafoRotulado<int, char>;
template class GrafoRotulado<int, double>;
template class GrafoRotulado<double, double>;
template class GrafoRotulado<double, int>;
template class GrafoRotulado<char, double>;
template class GrafoRotulado<double, char>;
template class GrafoRotulado<string, int>;
template class GrafoRotulado<int, string>;
template class GrafoRotulado<string, string>;
