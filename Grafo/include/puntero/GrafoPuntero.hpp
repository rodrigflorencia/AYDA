...
public:
  ...
  void setPeso(const V &deVertice, const V &aVertice, const C &costo);
...
private:
  ...
  struct Nodo {
    ...
    Nodo *sig;
    Arco *ady;
    int incidencias; // para reducir la complejidad a la hora de calcular
                     // grados, recorrer ady, ...
